...
const updateUI = (): void => {
  ...
  const labelMap: Record<string, string> = {
    ...
    "popup-fab-popup-launch-label": "popup_fab_popup_launch",
    "popup-fab-friends-book-label": "popup_fab_friends_book",
    "popup-fab-map-filter-label": "popup_fab_map_filter",
    "popup-fab-status-bar-label": "popup_fab_status_bar",
