...
export const enTranslations = {
  ...
  popup_paint_mode_style: "Hide Buttons on Paint Mode",
  popup_overlay_mode: "Overlay",
  popup_overlay_mode_composite: "Composite",
  popup_overlay_mode_composite_lite: "Composite + No Stats",
...
Do not use this feature to paint actual pixels.`,
  ...
  data_saver_rendering_paused: "Using Offline Cache",
  ...
  confirm_reset_areas:
    "Are you sure you want to delete all areas? This action cannot be undone.",
  ...
  map_filter_area_large_file_warning:
    "Large file detected. Processing may take some time. Continue?",
  file_size: "File size",
  popup_close_button_big: "Big Close Button",
  map_filter_area_display_settings: "Display Settings",
  map_filter_area_opacity: "Area Opacity",
  map_filter_area_name_display: "Area Name Display",
  map_filter_area_name_display_on: "Show",
  map_filter_area_name_display_off: "Hide",
  map_filter_area_name_font_size: "Font Size",
  map_filter_area_name_style: "Text Appearance",
  map_filter_area_name_style_halo: "Standard",
  map_filter_area_name_style_badge: "Circle Badge",
  map_filter_area_group_compose: "Area Merge",
  map_filter_area_group_compose_action: "Merge",
  map_filter_area_group_not_enough: "Not enough areas to merge",
  ...
  tmp_tile_board_data_notice:
    "Shows only already received tile data. To reduce server load, no new requests are sent.",
  ...
  popup_overlay_mode_composite_lite_detail:
    "Minimal and lightest (transparent + dot, skip compare/stats)",
  ...
  popup_fab_visibility_show: "Show Button Settings",
  popup_fab_visibility_hide: "Hide Button Settings",
  popup_fab_popup_launch: "Popup Button",
  ...
  draft_blocked_notice: "Draft mode: not sent",
  draft_confirm_body: "Enable draft mode? Pixels will NOT be sent to wplace and no charges are used. Turn it off before painting for real.",
  draft_save: "Save draft",
  draft_discard_confirm: "Turn off draft mode? The current draft will be discarded.",
