...
export const enTranslations = {
  ...
  quantization_rgb_euclidean: "RGB Distance (Fast, Default)",
  ...
  popup_fab_color_filter: "Color Filter",
  popup_fab_data_saver: "Data Saver",
  popup_fab_map_filter: "Map Filter",
  ...
  enhanced_mode_huge_red_cross: "Huge Colored Cross",
  enhanced_mode_huge_red_cross_bold: "Huge Colored Cross (Bold)",
  enhanced_mode_huge_red_diamond: "Huge Colored Diamond",
  enhanced_mode_huge_red_ring: "Huge Colored Ring",
...
Do not use this feature to paint actual pixels.`,
  ...
  user_id: "User ID",
  user_id_placeholder: "e.g. 12345",
  user_name: "User Name",
  user_name_placeholder: "e.g. PlayerName",
  please_enter_id_and_name: "Please enter ID and name",
  ...
  map_filter_area_mode_editing: "Editing",
  map_filter_area_editing: "Editing",
  map_filter_area_start_new: "Start New Edit",
  map_filter_area_stop_editing: "Stop Editing",
  map_filter_area_save_new: "Save as New",
  map_filter_area_save_update: "Save Update",
  map_filter_area_saved_regions: "Saved Areas",
  map_filter_area_empty: "No saved areas",
  ...
  map_filter_area_default_name: "Area",
  map_filter_area_new_region: "New Area",
  map_filter_area_need_polygon: "No editable polygon found",
  ...
  outline_preserve: "Outline Preserve",
  ...
  danger_zone_show: "Show Reset Options",
  danger_zone_hide: "Hide Reset Options",
  reset_areas: "Reset All Areas",
  confirm_reset_areas: "Are you sure you want to delete all areas? This action cannot be undone.",
  areas_reset_success: "All areas have been successfully deleted.",
  import_mode: "Import Mode",
  map_filter_area_enable_display: "Enable area display after import",
  map_filter_area_groups: "Groups",
