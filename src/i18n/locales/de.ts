...
Verwende diese Funktion nicht zum Zeichnen echter Pixel.`,
  ...
  draft_blocked_notice: "Entwurfsmodus: nicht gesendet",
  draft_confirm_body: "Entwurfsmodus aktivieren? Pixel werden NICHT an wplace gesendet und keine Ladungen verbraucht. Vor echtem Malen ausschalten.",
  draft_save: "Entwurf speichern",
  draft_discard_confirm: "Entwurfsmodus ausschalten? Der aktuelle Entwurf wird verworfen.",
  draft_save_failed: "Entwurf konnte nicht gespeichert werden",
};
