  ...
  modal.innerHTML = `
    <div class="modal-box max-w-2xl">
      ...
      <div class="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 class="font-bold text-xl">${t("offline_cache_settings")}</h3>
        </div>
      </div>
      ...
      <div class="mb-6">
        <div class="flex justify-between text-sm mb-2">
          ...
          <span class="font-semibold">${currentCacheSize} / ${maxCacheSize} ${t("tiles")}</span>
        </div>
      ...
      <div class="form-control mb-6">
        <label class="label">
          <span class="label-text font-semibold">${t("maximum_cache_size")}</span>
        </label>
        <div class="flex items-center gap-4">
          ...
          <div class="text-right" style="flex-shrink: 0;">
            <div class="text-lg font-bold" id="cache-size-value">${maxCacheSize} ${t("tiles")}</div>
          </div>
        </div>
      </div>
      ...
      <div class="modal-action mt-6">
        <button id="cancel-btn" class="btn btn-ghost">${t("cancel")}</button>
