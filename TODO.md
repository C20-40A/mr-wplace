...
- ギャラリーの完成までの pixel 数、ちょっと多すぎる気がする。透明もカウントされている？
  - いや更新が意味不明 89/1,442 になったり、89/1,442 になったり。つまりカラーフィルター込みでカウントしている？
  - タイルに表示中はいいんだけど、別の場所に移動すると、表示がバグる. %もしょっちゅう変わる
